...
- (id)initWithTmdbId:(NSInteger)tmdbId seasonNumber:(NSInteger)seasonNumber completionHandler:(ConnectionTvSeasonHandler)handler {
    ...
    if ([Cache cachedSeasons][StringSeasonId(self.tmdbId, self.seasonNumber)]) {
    ...
    self = [super initWithParameters:@{} completionHandler:^(WebserviceResultCode code, NSMutableDictionary *resultDictionary, NSError *error) {
        ...
        if (code == WebserviceResultOk) {
            ...
            [Cache cachedSeasons][StringSeasonId(self.tmdbId, self.seasonNumber)] = tmdbTvSeason;
...
- (void)cachedResponse {
    ...
    self.customHandler(WebserviceResultOk, [Cache cachedSeasons][StringSeasonId(self.tmdbId, self.seasonNumber)]);
